...
backend/
  ...
  api/          # HTTP 路由与请求响应契约
  config/       # 环境变量与能力清单
  context/      # Runtime Context 双通道与多来源 Context Builder
